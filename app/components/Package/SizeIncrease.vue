  ...
  >
    ...
    <div class="mt-3 flex flex-col gap-3">
      ...
      <Transition name="expand">
        <div v-if="summary || error" class="flex flex-col">
          <div v-if="error" class="border-t border-amber-600/20 pt-3 flex flex-col">
            <div
          ...
          <template v-else-if="summary">
            ...
            <div class="border-t border-amber-600/20 pt-3 flex flex-col gap-1">
              ...
              <p class="text-xs text-amber-700 dark:text-amber-500 m-0">
                <span aria-hidden="true">🧩</span>
                <i18n-t
                  keypath="package.size_increase.analyze.summary.deps_variation"
                  scope="global"
                >
                  <template #net>{{
...
.expand-leave-active {
  ...
  overflow: hidden;
  opacity: 1;
  max-height: 800px; /* 🔥 NECESARIO: Sin esto, max-height pega un salto instántaneo a su altura final 🔥 */
}
